...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "appSettings.remote.accessSection": "Access",
    "appSettings.remote.accessLink": "Access Link",
    "appSettings.remote.accessHint": "Scan or open in browser",
    "appSettings.remote.copy": "Copy",
    "appSettings.remote.copied": "Copied",
    "appSettings.remote": "Remote",
    "appSettings.remote.running": "Server running on port {port}",
    "appSettings.remote.stopped": "Server not started",
    "appSettings.remote.openPanel": "Open panel",
    "appSettings.remote.serverSection": "Server",
    "appSettings.remote.port": "Port",
    "appSettings.remote.portHint": "Port for the local HTTP server (1024-65535)",
    "appSettings.remote.feishuSection": "Feishu Bot",
    "appSettings.remote.appId": "App ID",
    "appSettings.remote.appSecret": "App Secret",
    "appSettings.remote.feishuHint": "Leave empty to start server without Feishu integration",
    "appSettings.remote.saved": "Saved",
    "appSettings.remote.saving": "Saving",
    ...
    "conversation.new": "New Task",
    "conversation.empty": "No conversations yet. Click + to create one.",
    "conversation.status.running": "running",
    "conversation.status.pending": "pending",
    "conversation.status.input_required": "needs attention",
    "conversation.status.done": "done",
    "conversation.status.failed": "failed",
    "conversation.status.cancelled": "cancelled",
    "conversation.status.todo": "todo",
    "conversation.status.detached": "detached",
    ...
    "welcome.back": "Back",
    "welcome.projectStatusRunning": "▶ Running",
    "welcome.projectStatusAttention": "⚠ Attention",
    ...
    "task.deletedWithUndo": "Deleted: {name}",
    "common.undo": "Undo",
    ...
    "newTask.todoNeedContent": "Add some content before saving as todo",
    ...
    "running.providerDefault": "Default",
    "running.providerMissing": "Provider missing",
    ...
    "remote.messagePlaceholder": "Message…",
    "remote.enableNotifications": "Enable notifications",
    "remote.notificationsOn": "Notifications on",
    "remote.notificationsDenied": "Notifications denied",
    "remote.notificationsUnsupported": "Notifications not supported",
    "usage.title": "Usage",
    ...
    "notification.action.viewDiff": "View Diff",
    "notification.action.viewSession": "View Session",
    "notification.action.resume": "Resume",
    "notification.action.navigate": "Go to task",
    ...
    "commandPalette.placeholder": "Search files... (type > for commands)",
    "commandPalette.commandPlaceholder": "Search commands...",
    "commandPalette.typeToSearch": "Type to search files...",
    "commandPalette.noResults": "No results found",
    "commandPalette.failed": "Search failed: {error}",
    "commandPalette.navigate": "navigate",
    "commandPalette.select": "select",
    "commandPalette.toggleMode": "toggle mode",
  ...
  zh: {
    ...
    "appSettings.remote.accessSection": "访问",
    "appSettings.remote.accessLink": "访问链接",
    "appSettings.remote.accessHint": "扫码或复制到浏览器打开",
    "appSettings.remote.copy": "复制",
    "appSettings.remote.copied": "已复制",
    "appSettings.remote": "远程",
    "appSettings.remote.running": "服务运行在端口 {port}",
    "appSettings.remote.stopped": "服务未启动",
    "appSettings.remote.openPanel": "打开面板",
    "appSettings.remote.serverSection": "服务器",
    "appSettings.remote.port": "端口",
    "appSettings.remote.portHint": "本地 HTTP 服务器端口（1024-65535）",
    "appSettings.remote.feishuSection": "飞书 Bot",
    "appSettings.remote.appId": "App ID",
    "appSettings.remote.appSecret": "App Secret",
    "appSettings.remote.feishuHint": "留空则仅启动 HTTP 服务器，不接入飞书",
    "appSettings.remote.saved": "已保存",
    "appSettings.remote.saving": "保存中",
    ...
    "conversation.new": "新建任务",
    "conversation.empty": "暂无对话，点击 + 新建。",
    "conversation.status.running": "运行中",
    "conversation.status.pending": "等待中",
    "conversation.status.input_required": "待确认",
    "conversation.status.done": "已完成",
    "conversation.status.failed": "失败",
    "conversation.status.cancelled": "已取消",
    "conversation.status.todo": "待办",
    "conversation.status.detached": "已断开",
    "conversation.status.interrupted": "异常中断",
    "time.justNow": "刚刚",
    ...
    "welcome.back": "返回",
    "welcome.projectStatusRunning": "▶ 运行中",
    "welcome.projectStatusAttention": "⚠ 需要确认",
    "task.newTask": "新建任务",
    ...
    "newTask.todoNeedContent": "请先输入内容再保存为待办",
    ...
    "running.providerDefault": "默认",
    "running.providerMissing": "服务商已失效",
    "session.thinking": "思考中…",
    "session.loading": "正在加载会话…",
    "session.unableToLoad": "无法加载会话：{error}",
    "session.noMessages": "会话文件中没有消息。",
    "remote.messagePlaceholder": "输入消息…",
    "remote.enableNotifications": "开启通知",
    "remote.notificationsOn": "通知已开启",
    "remote.notificationsDenied": "通知被拒绝",
    "remote.notificationsUnsupported": "通知不可用",
    "usage.title": "用量",
    ...
    "notification.action.viewDiff": "查看 Diff",
    "notification.action.viewSession": "查看会话",
    "notification.action.resume": "Resume",
    "notification.action.navigate": "前往",
    ...
    "commandPalette.placeholder": "搜索文件... (输入 > 切换到命令模式)",
    "commandPalette.commandPlaceholder": "搜索命令...",
    "commandPalette.typeToSearch": "输入关键词搜索文件...",
    "commandPalette.noResults": "未找到结果",
    "commandPalette.failed": "搜索失败：{error}",
    "commandPalette.navigate": "导航",
    "commandPalette.select": "选择",
    "commandPalette.toggleMode": "切换模式",
